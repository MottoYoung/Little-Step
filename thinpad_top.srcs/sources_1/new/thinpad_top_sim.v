...
(*mark_debug="true"*)reg sel_uart;
(*mark_debug="true"*)reg sel_uart_flag; // 1-flag 0-data
...
(*mark_debug="true"*)wire RX_FIFO_wr_en;
reg RX_FIFO_rd_en;
(*mark_debug="true"*)wire RX_FIFO_empty;
wire RX_FIFO_full;
reg [7:0] RX_FIFO_data_in;
(*mark_debug="true"*)wire [7:0] RX_FIFO_data_out;


assign base_ram_data = ~base_ram_we_n_r ? base_ram_data_r : 32'bz;
(*mark_debug="true"*)assign ext_ram_data = ~ext_ram_we_n_r ? ext_ram_data_r : 32'bz;
...
assign uart_rdata = sel_uart_flag ? {30'b0,!RX_FIFO_empty,!TX_FIFO_full} : {24'b0,RX_FIFO_data_out};


assign TX_FIFO_rd_en = ext_uart_start;
assign ext_uart_start = (!ext_uart_busy) && (!TX_FIFO_empty);
assign TX_FIFO_wr_en = cpu_data_avai;

(*mark_debug="true"*)assign RX_FIFO_wr_en=ext_uart_ready;
...
always @ (posedge clk_20M) begin
    if (reset_of_clk10M) begin
        ...
        RX_FIFO_rd_en <= (|cpu_data_we) ? 1'b0 : 1'b1;
        state <= 4'd4;
    end
    else begin        
        base_ram_addr_r <= cpu_inst_addr[21:2];
